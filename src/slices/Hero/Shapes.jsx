...
function Geometries() {
  ...
  const soundEffects = [
    new Audio("/sounds/impactWood_heavy_001.ogg"),
    new Audio("/sounds/impactMining_001.ogg"),
    new Audio("/sounds/impactWood_medium_000.ogg"),
  ];
...
function Geometry({ r, position, geometry, materials, soundEffects }) {
  ...
  function handleClick(e) {
    ...
    gsap.to(mesh.rotation, {
      ...
      y: `+=${gsap.utils.random(0, 5)}`,
      z: `+=${gsap.utils.random(0, 5)}`,
      duration: 1.3,
  ...
  useEffect(() => {
    let ctx = gsap.context(() => {
      setVisible(true);
      gsap.from(meshRef.current.children[0].scale, {
        x: 0,
        y: 0,
        z: 0,
        duration: 1,
